## Usage
1. Download the latest release from https://github.com/Keturishi-Github/FPSUnlocker
2. Extract `FPSUnlocker-main` into a folder
3. Run `FPSUnlocker.exe` before or after starting Roblox
4. Enjoy those [beautiful frames](https://i.imgur.com/vsLf04O.png) 👌

## FAQ

1. **Some files are being deleted and/or my anti-virus is detecting FPSUnlocker.exe as malware. What do I do?**

Any detections are most likely a false positive. If you don't trust me, feel free to download the repository and compile the project from source. Otherwise, add an exception to your anti-virus for `FPSUnlocker.exe` (or the folder it is in).
